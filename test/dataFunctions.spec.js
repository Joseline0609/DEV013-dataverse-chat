    ...
    expect(result).toEqual([
      {
        ...
        name: "Begonia",
        maintenanceNeeds:
          "Necesita riego regular y evitar la luz solar directa.",
      ...
      },
      {
        ...
        name: "Azalea",
        maintenanceNeeds:
          "Requiere suelo ácido y poda después de la floración.",
  ...
  it("returns the array in ascendant sorting", () => {
    ...
    expect(fakeData).toEqual([
      ...
      },
      {
        ...
        name: "Aloe Vera",
        maintenanceNeeds:
          "Riego escaso y exposición a pleno sol o sombra parcial.",
