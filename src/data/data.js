export const data = [
  ...
  },
  {
    ...
    imageUrl:
      "https://github.com/Etelbina/dataverse/blob/main/src/resources/Images/azalea.png?raw=true",
  ...
  },
  {
    ...
    shortDescription:
      "Hierba aromática con propiedades calmantes, usada en infusiones.",
    imageUrl:
      "https://github.com/Etelbina/dataverse/blob/main/src/resources/Images/manzanilla.png?raw=true",
  ...
  },
  {
    ...
    name: "Cilantro",
    description:
      "El cilantro es una hierba versátil que se utiliza en una variedad de cocinas alrededor del mundo. Sus hojas verdes y finamente divididas tienen un sabor fresco y cítrico, y se utilizan comúnmente en platos mexicanos, asiáticos y mediterráneos. Además de las hojas, las semillas de cilantro se utilizan como especia en la cocina. El cilantro también es apreciado por su valor medicinal y se cree que tiene propiedades digestivas y antioxidantes. En el jardín, el cilantro prefiere la luz solar parcial y suelos bien drenados. Es una planta anual que puede autosembrarse si se le permite.",
    shortDescription:
      "Hierba aromática con hojas y semillas utilizadas en cocina.",
    imageUrl:
      "https://github.com/Etelbina/dataverse/blob/main/src/resources/Images/cilantro.png?raw=true",
  ...
  },
  {
    ...
    name: "Arce",
    description:
      "El arce es conocido por sus hojas palmadas y sus coloridos cambios de follaje en otoño. Hay muchas especies de arces en todo el mundo, pero los arces japoneses y los arces rojos son particularmente apreciados por su belleza ornamental. Los arces japoneses tienen hojas delicadamente lobuladas que adquieren tonos rojos, naranjas y amarillos espectaculares durante el otoño. Los arces rojos son conocidos por sus hojas de cinco lóbulos que se vuelven rojas brillantes en otoño. Además de su atractivo estacional, los arces son valorados por su madera y la savia que se utiliza para hacer jarabe de arce.",
    shortDescription:
      "Árbol famoso por su savia para jarabe y hojas otoñales coloridas.",
    imageUrl:
      "https://github.com/Etelbina/dataverse/blob/main/src/resources/Images/arce.png?raw=true",
  ...
  },
  {
    ...
    shortDescription:
      "Planta aromática con flores púrpura, usada en cosmética y aromaterapia.",
    imageUrl:
      "https://github.com/Etelbina/dataverse/blob/main/src/resources/Images/lavanda.png?raw=true",
    botanicalFamily: "Lamiaceae",
    birthPlace: "Mediterráneo",
  ...
  },
  {
    ...
    applicationsPlant:
      "Jardinería en zonas áridas, ornamentación, uso medicinal.",
  ...
  },
  {
    ...
    shortDescription:
      "Árbol con tronco grueso, símbolo de vida en regiones áridas.",
    imageUrl:
      "https://github.com/Etelbina/dataverse/blob/main/src/resources/Images/baobab.png?raw=true",
    botanicalFamily: "Malvaceae",
    birthPlace: "África, Madagascar, Australia",
    maintenanceNeeds:
      "Extremadamente resistente a la sequía, requiere muy poco riego.",
